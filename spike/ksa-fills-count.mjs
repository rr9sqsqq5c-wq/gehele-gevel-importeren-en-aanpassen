...
console.log('  IfcRelFillsElement:', n(wi.IFCRELFILLSELEMENT), ' <- koppeling opening<->kozijn');
console.log('  IfcRelVoidsElement:', n(wi.IFCRELVOIDSELEMENT), ' <- koppeling wand<->opening');
api.CloseModel(bid);
